      ...
      >
        <Box className={styles.container1}>
          ...
          >
            ...
            <Heading size={"xl"} zIndex={2} color={isDarkMode ? "#fff" : "#000"} >
              Why Choose Uifry?
            </Heading>
            <Box zIndex={2} position={"relative"}>
              ...
              >
                ...
                <Text fontWeight={"bold"} color={isDarkMode ? "wheat" : "#000"}>Clever Notifications</Text>
              </Center>
          ...
          >
            <Box zIndex={2} position={"relative"}>
              ...
              >
                ...
                <Text fontWeight={"bold"} color={isDarkMode ? "wheat" : "#000"}>Fully Customizable</Text>
              </Center>
              <Text color={isDarkMode ? "#fff" : "#000"}>
                Arcu at dictum sapien, mollis. Vulputate sit id accumsan,
                ultricies. In ultrices malesuada elit mauris etiam odio. Duis
