...
export default function AboutUs() {
  ...
  return (
    <Element name="aboutus" bgColor={isDarkMode ? "#000" : "white"}>
      <Center
        pt={"2rem"}
        display={"flex"}
      ...
      >
        ...
        <Heading size={"xl"}>what our users say about us?</Heading>
      ...
      >
        ...
        >
          <Box
            ...
            gap={"1rem"}
          >
            <Heading size={"lg"} color={isDarkMode ? "wheat" : "#000"} >
            ...
            />
            <Text fontWeight={"bold"} color={isDarkMode ? "#fff" : "#000"}  >Nick Jonas</Text>
          </Box>
        </Box>
      </Box>
    </Element>
