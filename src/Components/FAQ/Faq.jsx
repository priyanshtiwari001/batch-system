    ...
    <Element name="faq">
      ...
      >
        ...
        <Box my={"2rem"}>
          ...
          <Heading size={"2xl"} color={isDarkMode ? "white" : "#E84D4D"}>Frequently Asked Questions</Heading>
        </Box>
        <Box className={styles.container} my={"2rem"}>
          {data.map((item) => (
            ...
            >
              <Heading size={"md"} color={isDarkMode ? "#fff" : "#000"}>{item.question}</Heading>
              <Text color={isDarkMode ? "gray.400" : "gray.500"}>{item.answer}</Text>
            </Box>
          ))}
        </Box>
